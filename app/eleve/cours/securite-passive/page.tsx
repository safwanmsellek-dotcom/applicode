    ...
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '32px 20px 80px', fontFamily: 'sans-serif', color: '#f0f2f8' }}>
      ...
      <div style={{ marginTop: 20, marginBottom: 32 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
          <div style={badge}>Fiche 27</div>
          <div style={{ fontSize: 11, color: '#6b7394' }}>Équipements de sécurité</div>
        </div>
        <h1 style={{ fontSize: 'clamp(22px, 4vw, 28px)', fontWeight: 800, lineHeight: 1.3 }}>Direction, pneumatiques, suspensions, freins</h1>
      </div>

      <SectionBlock>
        <p style={text}>Contenu du cours en cours de rédaction...</p>
      </SectionBlock>
    </div>
  )
}
